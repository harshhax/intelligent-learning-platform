      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Learning Difficulty Prediction System
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="harsha@bitsathy.ac.in"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg gradient-primary py-2.5 text-sm font-semibold text-primary-foreground shadow-primary hover:opacity-90 transition-opacity disabled:opacity-50"
            >
